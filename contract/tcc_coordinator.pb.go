...
const (
	...
	GetTransResponse_InvalidAppId       GetTransResponse_GetTransResponseErrorCode = 1001
	GetTransResponse_EmptyBusCode       GetTransResponse_GetTransResponseErrorCode = 1002
	GetTransResponse_EmptyTRXId         GetTransResponse_GetTransResponseErrorCode = 1003
	GetTransResponse_InvalidTransUniqId GetTransResponse_GetTransResponseErrorCode = 1010
)
...
var fileDescriptorTccCoordinator = []byte{
	...
	,
}
